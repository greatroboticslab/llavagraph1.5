"""
ViT classifier trained on FFT spectrum images instead of time-domain plots.
Adapted from train_vit_classifier.py for HPC (CUDA) and FFT split dataset.
"""
...
train_dir = "split_dataset_fft/train"
val_dir   = "split_dataset_fft/test"
output_dir = "vit_output_fft"
