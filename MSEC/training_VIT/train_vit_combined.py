"""
ViT classifier trained on combined FFT dataset (old fft_augmented_nm + new 2.20.2026).
Identical architecture to train_vit_fft.py; only data paths differ.
"""
...
train_dir  = "split_dataset_combined/train"
val_dir    = "split_dataset_combined/test"
output_dir = "vit_output_combined"
