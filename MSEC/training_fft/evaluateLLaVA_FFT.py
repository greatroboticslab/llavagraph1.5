...
Asks 3 questions per image (matching training questions):
  Q1: Tallest peak amplitude and whether above/below 60nm
  Q2: Amplitudes and frequencies of the two tallest peaks
  Q3: Decay shape after dominant peak
...
Usage:
    python evaluateLLaVA_FFT.py \
        ...
        --output-file results/fft/noise.json
"""
...
def main(args):
    ...
    # Ensure model_name contains 'llava' and 'lora' so builder uses correct loading path
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate LLaVA on FFT test images")
