...
## waveform-input-data/
Contains both experimental (original) and synthetic function generator input images.

## piezo-output-data/
Contains both experimental (original) and synthetic piezo displacement measurement images.

## textData/ -- old version
Contains text files with descriptions, generated by **script/generate_descriptions.py**

## textData_old/ --- old version
